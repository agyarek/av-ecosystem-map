...
CARDS = [
    ...
    ("funding", "Funding", "$41.8B ACROSS 30 EVENTS", None),
    ("economics", "The Arithmetic", "WILL ANY OF THIS PAY?", None),
    ("regulation", "Regulatory", "WHO IS ALLOWED TO DRIVE, AND WHO DECIDES", None),
    ("safety", "What Has Gone Wrong", "INCIDENTS · RECALLS · SYSTEMIC FAILURES", None),
    ("owning-one", "Can I Buy One?", "CONSUMER SELF-DRIVING WENT BACKWARDS", None),
